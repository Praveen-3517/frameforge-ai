...
class NextHigherPowerOfTwo {
    ...
    public static void main(String[] args) {
        System.out.println("=== Java HashMap tableSizeFor: Next Power of Two via Bit Smearing ===");

        int[] testCases = { 0, 1, 2, 3, 5, 8, 9, 15, 16, 17, 31, 32, 33, 100, 1023, 1024, 1025 };

        for (int n : testCases) {
            int nextPow = nextPowerOfTwo(n);
            System.out.printf("n = %4d ==> Next Power of 2: %4d | Binary: %s%n",
                    n, nextPow, Integer.toBinaryString(nextPow));
        }
    }
}
