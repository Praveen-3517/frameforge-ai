...
class CountSubarraysWithMedianK {
    ...
    public static void main(String[] args) {
        System.out.println("=== LeetCode 2448: Count Subarrays With Median K ===");

        int[] nums1 = { 3, 2, 1, 4, 5 };
        int k1 = 4;
        System.out.printf("Array: %s, k = %d ==> Subarrays with Median k: %d (Expected: 3)%n",
                java.util.Arrays.toString(nums1), k1, countSubarrays(nums1, k1));

        int[] nums2 = { 2, 3, 1 };
        int k2 = 3;
        System.out.printf("Array: %s, k = %d ==> Subarrays with Median k: %d (Expected: 1)%n",
                java.util.Arrays.toString(nums2), k2, countSubarrays(nums2, k2));
    }
}
