...
class ProductOfArrayExceptSelf {
    ...
    public static void main(String[] args) {
        System.out.println("=== LeetCode 238: Product of Array Except Self (Division-Free) ===");
        ...
        for (int[] arr : testArrays) {
            ...
            System.out.printf("Array: %-18s ==> Product Except Self: %s%n",
                    Arrays.toString(arr), Arrays.toString(prod));
        }
    }
}
