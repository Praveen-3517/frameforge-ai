 ...
 */
class FindDuplicateNumberFloydCycle {
    ...
    public static void main(String[] args) {
        System.out.println("=== LeetCode 287: Find Duplicate Number (Floyd's Cycle Loop) ===");
        ...
        for (int[] arr : testArrays) {
            ...
            System.out.printf("Array: %s ==> Duplicate: %d%n",
                    java.util.Arrays.toString(arr), duplicate);
        }
    }
}
