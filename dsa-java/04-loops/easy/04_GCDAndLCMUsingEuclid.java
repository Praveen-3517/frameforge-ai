...
class GCDAndLCMUsingEuclid {
    ...
    public static long lcm(long a, long b) {
        ...
        return Math.abs(a / commonGcd) * Math.abs(b);
    }

    public static void main(String[] args) {
        System.out.println("=== Euclidean GCD & Overflow-Safe LCM (While Loop) ===");
        ...
        for (long[] pair : testPairs) {
            long a = pair[0], b = pair[1];
            long g = gcd(a, b);
            long l = lcm(a, b);
            System.out.printf("Pair (%11d, %11d) ==> GCD: %11d | LCM: %15d%n", a, b, g, l);
        }
    }
}
