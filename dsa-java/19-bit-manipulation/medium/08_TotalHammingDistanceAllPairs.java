 ...
 */
class TotalHammingDistanceAllPairs {
    ...
    public static void main(String[] args) {
        int[] nums1 = {4, 14, 2};
        System.out.println("Total Hamming Distance: " + totalHammingDistance(nums1) + " (Expected: 6)");
        // Pairs: (4,14)=2, (4,2)=2, (14,2)=2 -> total=6

        int[] nums2 = {4, 14, 4};
        System.out.println("Total Hamming Distance: " + totalHammingDistance(nums2) + " (Expected: 4)");
    }
}
